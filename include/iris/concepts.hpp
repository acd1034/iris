...
namespace iris {
  ...
  IRIS_DEFINE_BNARY_CONCEPT(is_common_reference_with, T, U,
                            is_same_as<detected_common_reference_t<T, U>, detected_common_reference_t<U, T>>,
                            std::is_convertible<T, detected_common_reference_t<T, U>>,
                            std::is_convertible<U, detected_common_reference_t<T, U>>)
  IRIS_DEFINE_BNARY_CONCEPT(is_common_with, T, U,
                            is_same_as<detected_common_type_t<T, U>, detected_common_type_t<U, T>>,
                            std::is_convertible<T, detected_common_type_t<T, U>>,
                            std::is_convertible<U, detected_common_type_t<T, U>>,
                            is_common_reference_with<std::add_lvalue_reference_t<T const>, std::add_lvalue_reference_t<U const>>,
                            is_common_reference_with<
                              std::add_lvalue_reference_t<detected_common_type_t<T, U>>,
                              detected_common_reference_t<std::add_lvalue_reference_t<T const>, std::add_lvalue_reference_t<U const>>>)
  // types
  ...
  IRIS_DEFINE_BNARY_CONCEPT(is_totally_ordered_with, T, U,
                            ...
                            is_common_reference_with<std::remove_reference_t<T> const&, std::remove_reference_t<U> const&>,
                            is_totally_ordered<detected_common_reference_t<std::remove_reference_t<T> const&, std::remove_reference_t<U> const&>>,
